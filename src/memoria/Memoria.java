...
public class Memoria extends JFrame implements ActionListener {
    ...
    String brancoCard = "src\\memoria\\imagens\\logo.png";
    String diretorioCartas = "src\\memoria\\imagens\\icon\\";
    ...
    ReproduzAudio objreproduzAudio = new ReproduzAudio();

    public Memoria(int ptotalLacunaTabela, int pLevelMemoria, String level) {
        try {
            ...
            timerComparador = new Timer(2300, new Memoria.TemporizadorInicial());
        } catch (Exception ex) {
    ...
    private void criaImagensPadrao() {
        ...
        timer = new javax.swing.Timer(1200, new Memoria.TemporizadorInicial());
        //Starta o cronometro
        timer.start();

        int controladorTempo = 400 * totalLacunaTabela;

        timerShower = new javax.swing.Timer(controladorTempo, new Memoria.TemporizadorInicial());
        //Starta o cronometro
        timerShower.start();
    ...
    public void mostraImagens() {
        ...
        try {
            ...
            System.out.println("Erro ao criar os botões!");
        }
        ...
        try {
            ...
            if (primeiraEscolha != -1 && segundaEscolha != -1) {
                ...
                if (botoes[primeiraEscolha].getIcon().toString().equals(botoes[segundaEscolha].getIcon().toString()) && primeiraEscolha != segundaEscolha) {
                    ...
                    objreproduzAudio.playAudio("src\\memoria\\audio\\correct.wav");
                    ...
                    objreproduzAudio.playAudio("src\\memoria\\audio\\incorrect.wav");
    ...
    public void controlaFimJogo() {
        try {
            ...
            for (int index = 0; index < totalLacunaTabela; index++) {
                if (!botoes[index].getIcon().toString().equals(brancoCard)) {
                ...
                if (totalLacunaTabela == contadorFinal) {
                    ...
                    if (contadorJogadasAcertadasJogador > contadorJogadasAcertadasComputador) {
                        objreproduzAudio.playAudio("src\\memoria\\audio\\win.wav");
                    } else {
                        objreproduzAudio.playAudio("src\\memoria\\audio\\lose.wav");
                    }
